...
// Input Format
// The first line contains a single integer n, denoting the number of boxes.n lines follow with three integers on each separated by single spaces - length, width and height which are length, width and height in feet of the -th box.
